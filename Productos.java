...
public class Productos extends JFrame{
    ...
    public void enviarDatos(){
        String sql = "insert into almacen(nombreTextField, tipoArticuloComboBox,cantidadComboBox,proovedorJpanel, sucursalJpanel) values(?,?,?,?,?)";
        try{
            PreparedStatement pst = conectar.prepareStatement(sql);
            pst.setString(1,nombreTextField.getText());
            pst.setString(2,tipoArticuloComboBox.getName());
            pst.setString(3, cantidadComboBox.getName());
            pst.setString(4,tipoArticuloComboBox.getName());
